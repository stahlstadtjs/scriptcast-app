...
export const Header:SFC<{ episode?: PodcastItem, latest?: boolean }> = ({ episode, latest }) => {
  ...
  if (latest) {
    more = <>
      <PostLink classes="btn secondary" 
        title="Get to the shownotes of our latest episode" 
        id={getID(episode)}>More<span className="visually-hidden">on the latest Episode</span>
      </PostLink>
